...
| G5 | S4 — Two instances under one blueprint | **Done** | Instances `procodeagent` + `procodeagent2` provisioned under a shared blueprint app; see [docs/evidence/multi-instance-inheritance.md](evidence/multi-instance-inheritance.md) | — |
